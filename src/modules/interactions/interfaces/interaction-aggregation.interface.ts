...
export interface PropertyWithAuthorAggregation
  extends Omit<Property, 'author'> {
  author: Omit<User, 'password'>;
}

// Interface for Save document with populated Property and Author
export interface SaveWithPropertyAndAuthorAggregation
  extends Omit<Save, 'property'> {
  property: PropertyWithAuthorAggregation;
}

// Interface for Like document with populated Property and Author
export interface LikeWithPropertyAndAuthorAggregation
  extends Omit<Like, 'property'> {
  property: PropertyWithAuthorAggregation;
}
